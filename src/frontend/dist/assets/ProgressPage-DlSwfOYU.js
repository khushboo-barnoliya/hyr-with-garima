import { a as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, b as clsx, R as React, i as invariant, j as jsxRuntimeExports, P as PageLoading } from "./index-BLaxd34b.js";
import { c as createLucideIcon, l as useMyMeasurements, n as useLogMeasurement, o as useDeleteMeasurement, p as useMyPlans, q as useFitnessPlans, L as Layout, m as motion, B as Badge, D as Dumbbell, b as Button } from "./useBackend-CKG5PE8y.js";
import { C as Card } from "./card-emnBK9cC.js";
import { I as Input } from "./input-B1VeGqv0.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, P as Plus, c as TabsContent, L as Label$1 } from "./tabs-DZ0QK3m3.js";
...
const DEMO_MEASUREMENTS = [
  {
    id: BigInt(1),
    memberId: {},
    date: BigInt(Date.now() - 56 * 864e5) * BigInt(1e6),
    weightKg: 88,
    waistCm: 98,
    chestCm: 104,
    armsCm: 38,
  ...
  },
  {
    id: BigInt(2),
    memberId: {},
    date: BigInt(Date.now() - 42 * 864e5) * BigInt(1e6),
    weightKg: 85,
    waistCm: 95,
    chestCm: 105,
    armsCm: 39,
  ...
  },
  {
    id: BigInt(3),
    memberId: {},
    date: BigInt(Date.now() - 28 * 864e5) * BigInt(1e6),
    weightKg: 82,
    waistCm: 91,
    chestCm: 106,
    armsCm: 40,
  ...
  },
  {
    id: BigInt(4),
    memberId: {},
    date: BigInt(Date.now() - 14 * 864e5) * BigInt(1e6),
    weightKg: 80,
    waistCm: 88,
    chestCm: 107,
    armsCm: 41,
  ...
  },
  {
    id: BigInt(5),
    memberId: {},
    date: BigInt(Date.now() - 1 * 864e5) * BigInt(1e6),
    weightKg: 78,
    waistCm: 85,
    chestCm: 108,
    armsCm: 42,
...
function toChartData(measurements) {
  return [...measurements].sort((a2, b2) => Number(a2.date) - Number(b2.date)).map((m2) => ({
    date: new Date(Number(m2.date) / 1e6).toLocaleDateString("en-IN", {
      month: "short",
      day: "numeric"
    }),
    weight: m2.weightKg,
...
function toLatestBarData(m2) {
  return [
    { name: "Weight (kg)", value: m2.weightKg, color: "oklch(0.68 0.22 185)" },
    { name: "Waist (cm)", value: m2.waistCm, color: "oklch(0.72 0.25 55)" },
    { name: "Chest (cm)", value: m2.chestCm, color: "oklch(0.65 0.18 145)" },
    { name: "Arms (cm)", value: m2.armsCm, color: "oklch(0.78 0.2 25)" },
    { name: "Hips (cm)", value: m2.hipsCm, color: "oklch(0.62 0.2 265)" },
    { name: "Legs (cm)", value: m2.legsCm, color: "oklch(0.75 0.2 160)" }
  ];
}
const INITIAL_FORM = {
...
function ProgressPage() {
  ...
  const displayData = (measurements == null ? void 0 : measurements.length) ? measurements : DEMO_MEASUREMENTS;
  const latest = displayData[displayData.length - 1];
  const first = displayData[0];
  const chartData = toChartData(displayData);
  const barData = latest ? toLatestBarData(latest) : [];
  const weightChange = latest && first ? (latest.weightKg - first.weightKg).toFixed(1) : null;
  const waistChange = latest && first ? (latest.waistCm - first.waistCm).toFixed(1) : null;
  const planDetails = myPlans == null ? void 0 : myPlans.map((assignment) => ({
    assignment,
    plan: (fitnessPlans == null ? void 0 : fitnessPlans.find((p2) => p2.id === assignment.planId)) ?? null
  }));
  const handleSubmit = async (e3) => {
    ...
    try {
      ...
      ue.success("Measurements logged!");
      setForm(INITIAL_FORM);
    } catch {
      ue.error("Failed to log measurements.");
    }
  };
  const handleDelete = async (id) => {
    try {
      await deleteMeasurement.mutateAsync(id);
      ue.success("Measurement deleted.");
    } catch {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b border-border py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/15 text-primary border-primary/30 text-xs tracking-widest uppercase", children: "Member Portal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-3xl sm:text-4xl text-foreground mb-3", children: "YOUR PROGRESS JOURNEY" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-lg max-w-xl", children: "Track your measurements weekly and watch your transformation unfold in real-time." })
        ]
      }
    ) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-8", children: [
      latest && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatsCard,
          {
            ...
            unit: "kg",
            delta: weightChange ? `${weightChange}kg overall` : void 0,
            deltaPositive: weightChange ? Number(weightChange) < 0 : void 0,
            icon: TrendingDown,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatsCard,
          {
            ...
            unit: "cm",
            delta: waistChange ? `${waistChange}cm overall` : void 0,
            deltaPositive: waistChange ? Number(waistChange) < 0 : void 0,
            icon: TrendingDown,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            label: "Active Plans",
            value: (myPlans == null ? void 0 : myPlans.length) ?? 0,
            icon: Ruler,
            "data-ocid": "stat-plans"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "charts", className: "space-y-6", children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TabsTrigger,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { size: 15, "aria-hidden": "true" }),
                    " Progress Charts"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "log", className: "gap-1.5", "data-ocid": "tab-log", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 15, "aria-hidden": "true" }),
                " Log Measurements"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TabsTrigger,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Ruler, { size: 15, "aria-hidden": "true" }),
                    " History"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TabsTrigger,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { size: 15, "aria-hidden": "true" }),
                    " My Plans"
                  ]
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "charts", className: "space-y-6", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoading, { label: "Loading your progress..." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border p-6 shadow-subtle", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground mb-4", children: "Weight & Waist Trend" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border p-6 shadow-subtle", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground mb-4", children: "Arms Growth" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: chartData, children: [
          ...
          latest && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border p-6 shadow-subtle", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground mb-1", children: "Latest Measurement Breakdown" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body mb-4", children: "Snapshot of your most recent body composition metrics" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              BarChart,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "value", name: "Value", radius: [4, 4, 0, 0], children: barData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, entry.name)) })
                ]
              }
            ) })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "log", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border p-6 shadow-subtle max-w-2xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "history", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoading, { label: "Loading history..." }) : displayData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body", children: "No measurements yet. Start logging to see your journey!" })
            ]
          }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: [...displayData].reverse().map((m2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.tr,
            {
              ...
              "data-ocid": `measurement-row-${m2.id}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 font-body text-xs text-muted-foreground whitespace-nowrap", children: new Date(
                  Number(m2.date) / 1e6
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 font-mono font-bold text-foreground text-right", children: m2.weightKg }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 font-mono text-muted-foreground text-right", children: m2.waistCm }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 font-mono text-muted-foreground text-right", children: m2.chestCm }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 font-mono font-bold text-primary text-right", children: m2.armsCm }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 font-mono text-muted-foreground text-right", children: m2.hipsCm }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 font-mono text-muted-foreground text-right", children: m2.legsCm }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 font-body text-xs text-muted-foreground italic max-w-[140px] truncate", children: m2.notes }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    "data-ocid": `btn-delete-measurement-${m2.id}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "plans", children: !(myPlans == null ? void 0 : myPlans.length) ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg mb-2", children: "No active plans" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm", children: "Contact Garima to get a fitness plan assigned to your profile." })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: planDetails == null ? void 0 : planDetails.map(({ assignment, plan }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border p-5 shadow-subtle hover:shadow-elevated transition-smooth h-full flex flex-col gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-primary/15 text-primary border-primary/30 text-xs", children: "Active" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground mb-1", children: (plan == null ? void 0 : plan.name) ?? "Fitness Plan" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body line-clamp-2", children: (plan == null ? void 0 : plan.description) ?? "Your personalized fitness program." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 text-xs text-muted-foreground", children: [
                plan && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    ...
                    " ",
                    new Date(
                      Number(assignment.assignedAt) / 1e6
                    ).toLocaleDateString()
                  ] })
                ] }),
                assignment.expiresAt && assignment.expiresAt > BigInt(0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-accent", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 12, "aria-hidden": "true" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    "Expires",
                    " ",
                    new Date(
                      Number(assignment.expiresAt) / 1e6
                    ).toLocaleDateString()
                  ] })
                ] }),
                plan && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 12, "aria-hidden": "true" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    "₹",
                    plan.price
                  ] })
